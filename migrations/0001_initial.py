    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(editable=False, to=settings.AUTH_USER_MODEL, verbose_name='created by')),
                ('scenario', models.ForeignKey(verbose_name='scenario', to='condottieri_scenarios.Scenario')),
            ],
            options={
                'verbose_name': 'game',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('board_area', models.ForeignKey(to='condottieri_scenarios.Area')),
                ('game', models.ForeignKey(to='machiavelli.Game')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('game', models.ForeignKey(editable=False, to='machiavelli.Game')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('game', models.ForeignKey(to='machiavelli.Game')),
                ('trade_route', models.ForeignKey(to='condottieri_scenarios.TradeRoute')),
            ],
        ),
        migrations.CreateModel(
            name='Invitation',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('confirmed', models.BooleanField(default=False)),
                ('destination', models.ForeignKey(blank=True, to='machiavelli.GameArea', null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Player',
            fields=[
                ...
                ('conqueror', models.ForeignKey(related_name='conquered', blank=True, to='machiavelli.Player', null=True)),
                ('contender', models.ForeignKey(blank=True, to='condottieri_scenarios.Contender', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area', models.OneToOneField(to='machiavelli.GameArea')),
                ('player', models.ForeignKey(to='machiavelli.Player')),
            ],
        ),
        migrations.CreateModel(
            name='RetreatOrder',
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('area', models.ForeignKey(blank=True, to='machiavelli.GameArea', null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Revolution',
            fields=[
                ...
                ('game', models.ForeignKey(to='machiavelli.Game')),
                ('government', models.ForeignKey(related_name='revolutions', to=settings.AUTH_USER_MODEL)),
                ('opposition', models.ForeignKey(related_name='overthrows', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('area', models.ForeignKey(to='machiavelli.GameArea')),
            ],
        ),
        migrations.CreateModel(
            name='Team',
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('game', models.ForeignKey(verbose_name='game', to='machiavelli.Game')),
            ],
            options={
                'ordering': ['-game'],
                'verbose_name': 'team',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('player', models.ForeignKey(verbose_name='player', to='machiavelli.Player')),
            ],
            options={
                'ordering': ['-created_at'],
            },
        ...
        migrations.AddField(
            ...
            name='unit',
            field=models.ForeignKey(to='machiavelli.Unit'),
        ),
        migrations.AddField(
            model_name='score',
            name='team',
            field=models.ForeignKey(verbose_name='team', blank=True, to='machiavelli.Team', null=True),
        ),
        migrations.AddField(
            model_name='score',
            name='user',
        ...
        migrations.AddField(
            model_name='order',
            name='player',
            field=models.ForeignKey(to='machiavelli.Player', null=True),
        ),
        migrations.AddField(
            model_name='order',
            name='subdestination',
            field=models.ForeignKey(related_name='affecting_orders', blank=True, to='machiavelli.GameArea', null=True),
        ),
        migrations.AddField(
            model_name='order',
            name='subunit',
            field=models.ForeignKey(related_name='affecting_orders', blank=True, to='machiavelli.Unit', null=True),
        ),
        migrations.AddField(
            model_name='order',
            name='unit',
        ...
        migrations.AddField(
            model_name='loan',
            name='player',
            field=models.OneToOneField(to='machiavelli.Player'),
        ),
        migrations.AddField(
            model_name='gamearea',
            name='home_of',
            field=models.ForeignKey(related_name='homes', blank=True, to='machiavelli.Player', null=True),
        ),
        migrations.AddField(
            model_name='gamearea',
            name='player',
            field=models.ForeignKey(blank=True, to='machiavelli.Player', null=True),
        ),
        migrations.AddField(
            model_name='expense',
            name='area',
            field=models.ForeignKey(blank=True, to='machiavelli.GameArea', null=True),
        ),
        migrations.AddField(
            model_name='expense',
            name='player',
            field=models.ForeignKey(to='machiavelli.Player'),
        ),
        migrations.AddField(
            model_name='expense',
            name='unit',
            field=models.ForeignKey(blank=True, to='machiavelli.Unit', null=True),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='diplomat',
            name='area',
            field=models.ForeignKey(to='machiavelli.GameArea'),
        ),
        migrations.AddField(
            model_name='diplomat',
            name='player',
        ...
        migrations.AddField(
            ...
            name='game',
            field=models.OneToOneField(editable=False, to='machiavelli.Game', verbose_name='game'),
        ),
        migrations.AddField(
            model_name='assassination',
            name='killer',
            field=models.ForeignKey(related_name='assassination_attempts', to='machiavelli.Player'),
        ),
        migrations.AddField(
            model_name='assassination',
            name='target',
            field=models.ForeignKey(related_name='assassination_targets', to='machiavelli.Player'),
        ),
        migrations.AddField(
            model_name='assassin',
            name='owner',
        ...
        migrations.AddField(
            model_name='assassin',
            name='target',
            field=models.ForeignKey(to='condottieri_scenarios.Country'),
        ),
        migrations.CreateModel(
            name='LiveGame',
            fields=[
